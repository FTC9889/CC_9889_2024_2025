package com.team9889.ftc2024.opmode.old;
...
public class Testing_something extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()){
            ...
            //if (!test.isBusy())
                //target+=1000;
            double distance = colorsensor1.getNormalizedColors().red + colorsensor1.getNormalizedColors().blue + colorsensor1.getNormalizedColors().green;
            telemetry.addData("color red", colorsensor1.getNormalizedColors().red * 1000);
            telemetry.addData("color blue", colorsensor1.getNormalizedColors().blue * 1000);
            telemetry.addData("color green", colorsensor1.getNormalizedColors().green * 1000);
            telemetry.addData("distance", distance / 3.0 * 1000);
